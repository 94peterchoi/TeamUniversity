...
<form name="updateGameForm" method="post" enctype="multipart/form-data" action="updateGameAction.m">
...
<table align="center">
	...
	<tr>
	    ...
	    <td><input name="code" type="text" value="${dto.code}"><br><br></td>
    </tr>
    
    <tr>
   	  	<td><label for="price">정상가</label><br><br></td>
	    <td><input name="price" type="text" value="${dto.price}"><br><br></td>
    </tr> 	
    
	<tr>
      <td><label for="price2">할인가(할인하지 않는다면 0)<br><br></label></td>
      <td><input name="price2" type="text" value="${dto.price2}"><br><br></td>
    </tr>
     
      
	<tr>
      <td><label for="trailer">트레일러<br><br></label></td>
      <td><input name="trailer" type="text" value="${dto.trailer}"><br><br></td>
    </tr>
  ...
  <div class="wrap">
    ...
    <div class="row">
      ...
      <div class="column2" style="background-color:#1c1c1c;">
      	<textarea rows="10" cols="60" name="description" placeholder="게임 설명 부분">${dto.description}</textarea>
      </div>
  ...
  <div class="wrap">
    <div class="row">
      ...
      <label for="title">게임제목</label><br>
      	<input name="title" type="text" size="12" value="${dto.title}">
      </div>
      <div class="second-column2" style="background-color:#1c1c1c;">
        <table style="width:100%;" border="0">
          <tr>
            <td>개발사<br><input name="developer" type="text" value="${dto.developer}"><br><br></td>
            <td>퍼블리셔<br><input name="publisher" type="text" value="${dto.publisher}"><br><br></td>
            <td>출시일<br><input type="text" id="Date" name="publishing_date" value="${dto.publishing_date}"><br><br></td>
          </tr>
          <tr>
            <td>태그<br><input name="genre" type="text" value="${dto.genre}"></td>
            <td>게임이용등급<br><input name="rate" type="text" value="${dto.rate}"></td>
            <td>플랫폼<br><input name="platform" type="text" value="${dto.platform}"></td>
          </tr>
        </table>
      </div>
    </div>
