      ...
      <div id="login-row" class="row justify-content-center align-items-center">
        <div id="login-column" class="col-md-6">
          <div id="login-box" class="col-md-12">
            ...
            <form id="login-form" name="loginForm" class="form" action="deleteProfileView.do" method="post" onsubmit="return loginCheck();">
            <c:choose>
              ...
              <h3 class="text-center text-secondary">회원탈퇴</h3>
...
<!--               <div class="form-group">
 ...
 -->              
              ...
              <div class="form-group">
                <input type="submit" name="submit" class="btn btn-info btn-md" value="회원탈퇴하기">
              </div>
