                    ...
                    <div class="col-md-6">
                        <div class="profile-head">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">							
                                    <a class="nav-link" id="userinfo-tab" data-toggle="tab" href="profile.do?userId=${dto.id}" role="tab" aria-controls="userinfo" aria-selected="false">유저정보</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" id="pointinfo-tab" data-toggle="tab" href="viewPoint.do?userId=${dto.id}" role="tab" aria-controls="pointinfo" aria-selected="true">포인트내역</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8">
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
								...
								<!-- 페이지 컨트롤 -->
								<table style="width:100%; margin-left:auto; margin-right: auto; font-size:20px;">
									<tr>
										<th align="center">
											<c:if test="${cnt >0}">
