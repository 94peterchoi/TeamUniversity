...
<jsp:include page="navigation.jsp" />
  ...
  <div class="wrap">
    ...
    <div class="row">
      ...
      <c:if test="${buyornot == 0}">
	      <div class="column3" style="background-color:#1c1c1c;">
	        <br>
	        <a href="buy.do?gamelogo=${dto.gamelogo}&code=${dto.code}&title=${dto.title}&publisher=${dto.publisher}&price=${dto.price}" class="button">지금 구매하기<br>${dto.price}₩</a>
	        <br><br>
	        <button class="button" style="background-color: green;" onclick="pick(${dto.code}, ${dto.num}, ${pageNum}, ${number})">장바구니 담기</button>
	      </div>
	  </c:if>
	  <c:if test="${buyornot == 1}">
	      <div class="column3" style="background-color:#1c1c1c;">
	        <br>
	        <button class="button">이미 구매한 상품</button>
	        <br><br>
	        <button class="button">이미 구매한 상품</button>
	      </div>
	  </c:if>
      <c:if test="${buyornot == 2}">
	      <div class="column3" style="background-color:#1c1c1c;">
	        <br>
	        <a href="buy.do?gamelogo=${dto.gamelogo}&code=${dto.code}&title=${dto.title}&publisher=${dto.publisher}&price=${dto.price}" class="button">지금 구매하기<br>${dto.price}₩</a>
	        <br><br>
	        <button class="button" style="background-color: green;">장바구에 담김</button>
	      </div>
	  </c:if>
